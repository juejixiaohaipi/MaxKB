...
const getChatContainerHtml=(protocol,host,token,query,lang)=>{
 return `<div id="maxkb-chat-container">
<iframe id="maxkb-chat" allow="microphone" src=${protocol}://${host}/chat/${token}?lang=${lang}mode=embed${query}></iframe>
...
const initChat=(root)=>{
  ...
  // 添加对话框
  root.insertAdjacentHTML('beforeend',getChatContainerHtml('{{protocol}}','{{host}}','{{token}}','{{query}}','{{lang}}'))
  // 按钮元素
